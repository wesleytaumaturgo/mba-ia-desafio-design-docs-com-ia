...
| RFC-QA-05 | Política de retentativa: a ata tem três leituras incompatíveis | `[09:17] Larissa` fecha "5 tentativas"; `[09:17] Diego` enumera cinco degraus e soma "quase 15 horas" | `[09:17] Larissa` · `[09:17] Diego` | O pacote publica os cinco degraus e consome os quatro primeiros; o 12h exigiria uma 6ª. Falta ratificar |
